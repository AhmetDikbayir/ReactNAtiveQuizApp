  ...
  const handleQuestionSave = async () => {
    ...
    if (imageUri != '') {
      try {
        ...
        ToastAndroid.show('Failed to upload image. Please try again.', ToastAndroid.LONG);
    ...
    try {
      ...
      ToastAndroid.show('Failed to save question. Please try again.', ToastAndroid.LONG);
    }
  };
